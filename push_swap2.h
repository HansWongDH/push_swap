...
/*   Updated: 2022/03/22 01:27:38 by wding-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_stack	*partition_b(t_stack **lsta, t_stack **lstb, t_add **a);
void	sorting(t_stack **stka, t_stack **stkb, t_add **a, t_add **b);
void	sort(t_stack **stka, t_stack **stkb, t_add **a, t_add **b);
void	sort_a(t_stack **stka, t_stack **stkb, t_add **a, t_add **b);
void	sort_b(t_stack **stka, t_stack **stkb, t_add **a, t_add **b);
